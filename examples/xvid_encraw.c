...
static 	int ARG_QUALITY = 4;//hepeisong
...
static 	int ARG_VHQMODE = 1; //hepeisong, choose "1" is RD while choose "6" is default(SAD) 
	 ...
	 char *argv[])
{
	...
	argc  = 27;
	argv[0] = "/home/hps/Lab/WangWan/xvidcore/examples/xvid_encraw";
	argv[1] = "-i";
	argv[2] = "/home/hps/Desktop/akiyo.yuv";
	argv[3] = "-type";
	argv[4] = "0";
	argv[5] = "-w";
	argv[6] = "352";
	...
	argv[24] = "1";
	argv[25] = "-o";
	argv[26] = "aaabbbccc.m4v";  //hepeisong;
...
enc_init(void **enc_handle, char *stats_pass1, int start_num)
{
	...
	xvid_enc_create.profile = 0x03; /*0xf5;*/ /* Unrestricted *//*hepeisong*/
